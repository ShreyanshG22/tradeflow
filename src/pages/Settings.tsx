...
const Settings = () => {
  ...
  // Simulate setting changes to trigger unsaved changes state
  useEffect(() => {
  ...
  const resetSettings = (type: 'all' | 'section') => {
    toast({
      title: `Settings ${type === 'all' ? 'completely' : 'partially'} reset`,
      description: `${type === 'all' ? 'All' : 'Selected'} settings have been reset to default values.`,
    });
    setResetConfirmOpen(false);
  };

  const exportSettings = (format: 'json' | 'csv' | 'xml') => {
    toast({
      title: `Settings exported as ${format.toUpperCase()}`,
  ...
  const SettingsSidebar = () => (
    <div className="w-72 border-r h-full shrink-0 bg-background">
      ...
      <div className="absolute bottom-4 w-[250px] px-4">
        <Button 
          className={`w-full ${hasUnsavedChanges ? 'bg-primary' : 'bg-muted text-muted-foreground'}`} 
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Input id="name" defaultValue="Alex Johnson" onChange={handleInputChange} />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="email">Email</Label>
                        <Input id="email" type="email" defaultValue="alex@example.com" onChange={handleInputChange} />
                      </div>
                      <div className="space-y-2">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Input id="current-password" type="password" onChange={handleInputChange} />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="new-password">New Password</Label>
                        <Input id="new-password" type="password" onChange={handleInputChange} />
                      </div>
                    </div>
                    <div className="flex items-center space-x-2 pt-2">
                      <Switch id="2fa" onCheckedChange={handleInputChange} />
                    ...
                    <div className="border rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <Input id="zerodha-api-key" defaultValue="********ABCD" type="password" onChange={handleInputChange} />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="zerodha-api-secret">API Secret</Label>
                          <Input id="zerodha-api-secret" defaultValue="*****************" type="password" onChange={handleInputChange} />
                        </div>
                      </div>
                    ...
                    <div className="border rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <Input id="fyers-api-key" placeholder="Enter API Key" onChange={handleInputChange} />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="fyers-api-secret">API Secret</Label>
                          <Input id="fyers-api-secret" placeholder="Enter API Secret" onChange={handleInputChange} />
                        </div>
                      </div>
                      <div className="mt-4">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between border-b pb-4">
                        ...
                        <Switch id="tradingview-webhook" onCheckedChange={handleInputChange} />
                      </div>
                      ...
                      <div className="flex items-center justify-between border-b pb-4">
                        ...
                        <Switch id="telegram-webhook" defaultChecked onCheckedChange={handleInputChange} />
                      </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Input id="default-position-size" type="number" defaultValue="2" min="0.1" max="100" step="0.1" onChange={handleInputChange} />
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="max-open-positions" type="number" defaultValue="5" min="1" max="50" onChange={handleInputChange} />
                        <p className="text-xs text-muted-foreground mt-1">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="stop-loss" type="number" defaultValue="3" min="0.1" max="50" step="0.1" onChange={handleInputChange} />
                        <p className="text-xs text-muted-foreground mt-1">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="take-profit" type="number" defaultValue="6" min="0.1" max="100" step="0.1" onChange={handleInputChange} />
                        <p className="text-xs text-muted-foreground mt-1">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="w-[100px]">
                            <Input id="daily-loss-limit" type="number" defaultValue="5" min="0.1" max="100" step="0.1" onChange={handleInputChange} />
                          </div>
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                          ...
                          <div className="w-[100px]">
                            <Input id="daily-profit-target" type="number" defaultValue="10" min="0.1" max="100" step="0.1" onChange={handleInputChange} />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Select defaultValue="btcusd" onValueChange={handleInputChange}>
                          <SelectTrigger>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select defaultValue="1h" onValueChange={handleInputChange}>
                          <SelectTrigger>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="commission-rate" type="number" defaultValue="0.1" min="0" max="100" step="0.01" onChange={handleInputChange} />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="slippage">Slippage (%)</Label>
                        <Input id="slippage" type="number" defaultValue="0.05" min="0" max="100" step="0.01" onChange={handleInputChange} />
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Switch id="trade-executed" defaultChecked onCheckedChange={handleInputChange} />
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <Bell className="h-4 w-4 text-muted-foreground" />
                        ...
                        <Switch id="stop-loss-hit" defaultChecked onCheckedChange={handleInputChange} />
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <Bell className="h-4 w-4 text-muted-foreground" />
                        ...
                        <Switch id="take-profit-hit" defaultChecked onCheckedChange={handleInputChange} />
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <Bell className="h-4 w-4 text-muted-foreground" />
                        ...
                        <Switch id="new-signal" onCheckedChange={handleInputChange} />
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <Bell className="h-4 w-4 text-muted-foreground" />
                        ...
                        <Switch id="strategy-error" defaultChecked onCheckedChange={handleInputChange} />
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <Bell className="h-4 w-4 text-muted-foreground" />
                        ...
                        <Switch id="daily-summary" defaultChecked onCheckedChange={handleInputChange} />
                      </div>
                    </div>
                    ...
                    <div className="pt-4 border-t">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <Switch id="email-notifications" defaultChecked onCheckedChange={handleInputChange} />
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            <Mail
